...
An LSTM Neural Network was opted for because of the increased accuracy that it offers compared to a regular Neural Network.
...
\end{lstlisting} 
As the code shown indicates, this neural network has only 2 layers: LSTM and Dense.